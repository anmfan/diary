...
import {exportStudentsOrTeachersToExcel} from "@/components/admin-management/helper.ts";
import {allTeachers} from "@/redux/selectors/teachers-selector.ts";
import {allStudents} from "@/redux/selectors/students-selector.ts";
...
const AdminManagementEditNewButton = ({activeTab}: {activeTab: TTabsOptions}) => {
    ...
    const teachers = useAppSelector(allTeachers);
    const students = useAppSelector(allStudents);
    ...
    return (
        <div className={styles.editButtons}>
            ...
            <svg onClick={() => exportStudentsOrTeachersToExcel(arrayItemsForExport)} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
