...
import ManagementEmptyList from "@/components/management-empty-list/ManagementEmptyList.tsx";

const AdminManagementSchedule = () => {
...
export default AdminManagementSchedule;